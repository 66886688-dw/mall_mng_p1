...
@REM   MAVEN_BATCH_PAUSE - set to 'on' to wait for a keystroke after ending
...
if exist %WRAPPER_JAR% (
    ...
    if not "%MVNW_REPOURL%" == "" (
        SET WRAPPER_URL="%MVNW_REPOURL%/org/apache/maven/wrapper/maven-wrapper/3.1.0/maven-wrapper-3.1.0.jar"
    )
    if "%MVNW_VERBOSE%" == "true" (
